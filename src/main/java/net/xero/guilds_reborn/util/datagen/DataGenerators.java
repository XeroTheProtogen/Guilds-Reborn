...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        if (event.includeServer()) {
            GRBlockTags blockTags = new GRBlockTags(generator, event.getExistingFileHelper());
            generator.addProvider(blockTags);
            generator.addProvider(new GRItemTags(generator, blockTags, event.getExistingFileHelper()));
        }
